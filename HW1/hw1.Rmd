...
4. What's the output of following bash script?
    ...
    ```
**Solution:** This loop runs the "ls -l" command for each datafile ending in .gz in the /usr/203b-data/mimic-iv/core/ directory.
...
```{bash}
  ...
  tot= $(zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $1}' | tail -n+2 | sort -u | wc -l)
  echo "# of unique patients"
  echo $(( $tot-1 ))
  echo "Possible values of" 
  zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $6}' | head -n 1
  zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $6}' | tail -n+2 | sort -u
  echo "Possible values of" 
  zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $7}' | head -n 1
  zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $7}' | tail -n+2 | sort -u
  echo "Possible values of" 
  zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $9}' | head -n 1
  zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $9}' | tail -n+2 | sort -u
  echo "Possible values of" 
  zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $10}' | head -n 1
  zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $10}' | tail -n+2 | sort -u
  echo "Possible values of" 
  zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $11}' | head -n 1
  zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $11}' | tail -n+2 | sort -u
  echo "Possible values of" 
  zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $12}' | head -n 1
  zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | awk -F, '{print $12}' | tail -n+2 | sort -u
```
...
whoami
```
who prints info about the currently logged in user (who they are, when and where they logged in from)
``` {bash}
who
```
w prints information about the currently logged in user, what they are doing and uptime information
``` {bash}
w
```
...
```
time sleep 5 times how long it takes to execute the sleep 5 command, which tells the system to wait for 5 seconds before continuing
``` {bash}
time sleep 5
```
