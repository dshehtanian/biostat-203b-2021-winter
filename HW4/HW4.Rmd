...
```{r}
d30_true <- icu_analysis[icu_analysis$died_within_30d==1,1:28]
d30_false <- icu_analysis[icu_analysis$died_within_30d==0,1:28]
...
icu_train <- rbind(d30_true[smpl_true,1:28], d30_false[smpl_false,1:28])
x_train
y_train
icu_test <- rbind(d30_true[-smpl_true,1:28], d30_false[-smpl_false,1:28])
x_test
y_test
```
...
lgstc_reg <- glm(died_within_30d ~ gender + age_at_adm + marital_status + 
                   ...
                   hematocrit + wbc, data=icu_analysis, family = binomial)
summary(lgstc_reg)
